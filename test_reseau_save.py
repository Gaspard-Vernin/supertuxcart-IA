...
if __name__ == "__main__":
    ...
    env = RecordVideo(env, video_folder="./runs_stk", episode_trigger=lambda x: True)
    total_reward = 0
    total_distance = 0
    ...
    imageio.mimsave("run.mp4", frames, fps=30)
    print("vidéo sauvegardée : run.mp4")